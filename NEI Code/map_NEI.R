#' Map EPA NEI Original Data in VA 
#' 
#' @title map_NEI 
#' @param data .csv file containing EPA NEI original data. 
#' To obtain the same data sets, go to the EPA NEI databases and use the criteria:
#' State/county -> Virginia -> SO2, and leave all other options as default.
#' Download and save as a CSV file.
#' @return ggplot mapping of NEI data. 
#' @author Gabi Armada and Trajan Smeeth 
...
## ==================================================
#This code taken from https://github.com/r-spatial/sf/issues/231
#This function looks at Simple Features objects and pulls 
#geometric coordinates out, collecting them into columns x and y
#Very useful for us here as our geo information comes from USAB,
#which has lists of lists tied to each county
...
## ===========================================
#Pulled from https://github.com/yjunechoe/penngradlings/blob/master/R/ggplot2-annotations.R
#developed by June Choe using the ggfx library
#This function can plot geom_text() with up to 2 borders
#Useful for our county labels as some will be on the borders
